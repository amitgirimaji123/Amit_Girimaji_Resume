...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
  & \multirow{4}{*}{\includegraphics[scale=0.38]{DSC_6547.JPG}}\\
  & \\
%-----------------------------------------------------------  
...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|c|c|}
		\hline
		\hspace{0.2cm} Degree \hspace{0.2cm}                                            & College / School                                                                                        & \begin{tabular}[c]{@{}c@{}} \hspace{0.2cm} University \hspace{0.2cm} \\ / Board\end{tabular}       & Pass \%                                                      & \begin{tabular}[c]{@{}c@{}} \hspace{0.2cm} Passing \hspace{0.2cm} \\ Year\end{tabular} & Remarks                                                                        \\ \hline
		\begin{tabular}[c]{@{}c@{}}B.E\\ ECE\end{tabular} & \begin{tabular}[c]{@{}c@{}} \hspace{0.2cm} Jawaharlal Nehru National \hspace{0.2cm} \\  College of Engineering,\\  Shimoga\end{tabular} & VTU                                                                 & \begin{tabular}[c]{@{}c@{}}82.14\\ \hspace{0.2cm} up to 6th Sem \hspace{0.2cm} \end{tabular} & 2017                                                    & \begin{tabular}[c]{@{}c@{}}Tooper in\\ 1st and 3rd \\ semester\end{tabular}    \\ \hline
		PUC                                               & \begin{tabular}[c]{@{}c@{}}Sri Adichunchanagiri\\ Independent PU College,\\ Shimoga\end{tabular}        & \begin{tabular}[c]{@{}c@{}}Karnataka \\ State \\ Board\end{tabular} & 96.5                                                         & 2013                                                    & \begin{tabular}[c]{@{}c@{}} \hspace{0.2cm} CET,Rank- 468, \hspace{0.2cm} \\ 1st Rank\\  in college\end{tabular} \\ \hline
...
\begin{itemize} 
	\item Company:\hspace{1.4cm} \textbf{Rooftop Sundays} (Dec 2014 – Jan 2015)  \\
	Role of Internship :   Social media marketing - To reach certain number of people daily in SoundCloud.
	\item Company:\hspace{1.4cm} \textbf{Band - Camp Mobiles} (Mar 2015 – Aug 2015)  \\
...
\begin{itemize}
	...
	\item Adobe Photoshop, Adobe Auditon, Video editing
\end{itemize}
...
\begin{itemize}
	\item \textbf{Black Belt} in Karate, \textbf{4 National Level participations with 1 Bronze Medal} in Muay Thai, Wushu and Karate games
...
\begin{enumerate}
	...
	\item Attended \textbf{Microsoft TechVista 10}, A full day research symposium in Jan-2015
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\\
I hereby declare the information furnished above is true to best of my knowledge and belief.	
\\
Date: \textbf{\today}
